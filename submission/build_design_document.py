...
def build_document():
    ...
    add_table(
        ...
        [
            ("pinch", 2322, 522, 458, "81.65%", "83.53%", "82.57%"),
            ("clench", 2503, 349, 275, "87.76%", "90.10%", "88.92%"),
            ("up", 2326, 23, 65, "99.02%", "97.28%", "98.14%"),
            ("down", 2301, 39, 85, "98.33%", "96.44%", "97.38%"),
        ],
        [1300, 850, 850, 850, 1500, 1500, 1510],
    )
    add_body(doc, "六用户留一事件级宏 F1 为 91.75%。六折窗口准确率范围为 90.58% 至 93.52%。正确事件平均输出延迟约 309 ms。")
